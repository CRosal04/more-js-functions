...
// TO DO
function addTheValues( parame1, param2){
if(isNaN (parame1) || isNaN(param2)){
addToPage(" One of the parameters is not a number. When added they equal: " + param1 + " " + param2);
}
else{
addToPage("Both values are numbers. Added together they equal: " + (parseInt(parame1))+ (parseInt(param2)));
}
}
...
function scopeExample (){
    let localVariable = "This is a local variable inside of the scopeExample functions.";
...
// TO DO
scoreBasket();//score should have a value of 2
scoreBasket(); //= 4
...
// TO DO
addToPage (" The number variable ater doubling: " + number);
...
// TO DO
addToPage("The number varaiable after doubling again: " + number);
